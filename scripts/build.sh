...
GOOS="linux" GOARCH="ppc64le" go build -ldflags='-s -w' -o "linux/ppc64le/bin/helper" "$GOMOD/cmd/helper"
GOOS="linux" GOARCH="s390x" go build -ldflags='-s -w' -o "linux/s390x/bin/helper" "$GOMOD/cmd/helper"
